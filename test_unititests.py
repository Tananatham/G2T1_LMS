...
class TestClass(unittest.TestCase):
    def test_class_enrol(self):
        class1 = Class(class_id = '1', lesson_id = '1', course_name = 'PlaceHolder', start_date = 'Start', end_date = 'End', start_time = 'Start', end_time = 'End', class_size = '23', current_class_size = '4', employee_id = '5', duration_of_class ='5')
        class1.class_enroll()
        self.assertEqual(class1.class_size,5)

    def test_class_enrol_negative(self):
        class1 = Class(class_id = '1', lesson_id = '1', course_name = 'PlaceHolder', start_date = 'Start', end_date = 'End', start_time = 'Start', end_time = 'End', class_size = '23', current_class_size = '23', employee_id = '5', duration_of_class ='5')
